...
const socialLinks = [
    {
      href: 'https://www.github.com/Tanishk-Varshney',
    ...
    {
      href: 'https://www.linkedin.com/in/tanishk-varshney-profile',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://x.com/Tanishk_INDIAN',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/varshney.munda',
  ...
  return (
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <form action="https://getform.io/f/bjjmxrlb" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        <label htmlFor="name" className="label reveal-up">
                            Name
                        </label>
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Tanishk Varshney" className="text-field reveal-up" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="label reveal-up">
                            Email
                        </label>
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="tanishk@example.com" className="text-field reveal-up" />
                    </div>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder="Type your Message here!" required className="text-field resize-y min-h-32 max-h-80 reveal-up" />
                </div>
